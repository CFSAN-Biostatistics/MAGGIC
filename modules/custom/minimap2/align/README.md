...
Run `MINIMAP2_ALIGN` tool on input data. This module performs sequence alignment using Minimap2, supporting both PAF and BAM output formats for mapping reads to reference sequences.
