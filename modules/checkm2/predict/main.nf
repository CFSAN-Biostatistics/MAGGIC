process CHECKM2_PREDICT {
    ...
    module params.enable_module ? "${params.swmodulepath}${params.fs}checkm2${params.fs}1.1.0" : null
    conda params.enable_conda ? "conda-forge::scipy bioconda::checkm2=1.1.0" : null
